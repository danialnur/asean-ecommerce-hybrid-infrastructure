...
(IPv6 cross-site routing) — file numbers in `../evidences/phase-1-basic-connectivity/` and
`../evidences/phase-2-dynamic-routing-ipv6/` follow this same order.
...
![Topology overview](../evidences/phase-1-basic-connectivity/01-topology-overview.png)

## VLANs

**`MY-KL-HQ-CORE# sh vlan brief`**
![MY-KL-HQ-CORE sh vlan brief](../evidences/phase-1-basic-connectivity/02-vlan-brief-my-kl-hq-core.png)

**`PH-MNL-ACC# sh vlan brief`**
![PH-MNL-ACC sh vlan brief](../evidences/phase-1-basic-connectivity/03-vlan-brief-ph-mnl-acc.png)

**`TH-BKK-ACC# sh vlan brief`**
![TH-BKK-ACC sh vlan brief](../evidences/phase-1-basic-connectivity/04-vlan-brief-th-bkk-acc.png)

## Trunking

**`PH-MNL-ACC# sh interfaces trunk`**
![PH-MNL-ACC sh interfaces trunk](../evidences/phase-1-basic-connectivity/05-interfaces-trunk-ph-mnl-acc.png)

**`TH-BKK-ACC# sh interfaces trunk`**
![TH-BKK-ACC sh interfaces trunk](../evidences/phase-1-basic-connectivity/06-interfaces-trunk-th-bkk-acc.png)
...
![MY-KL-HQ-CORE etherchannel summary](../evidences/phase-1-basic-connectivity/07-etherchannel-summary-my-kl-hq-core.png)

**`MY-KL-HQ-CORE# sh interfaces trunk`** — `Po1` trunking, native VLAN 99, all 5 VLANs allowed
![MY-KL-HQ-CORE interfaces trunk](../evidences/phase-1-basic-connectivity/08-interfaces-trunk-my-kl-hq-core.png)

## HSRP & Spanning Tree

**`MY-KL-HQ-CORE# sh standby brief`** — all 4 HSRP groups active, no peer (single-core design)
![MY-KL-HQ-CORE sh standby brief](../evidences/phase-1-basic-connectivity/09-standby-brief-hsrp-my-kl-hq-core.png)

**`MY-KL-HQ-CORE# sh spanning-tree summary`** — rapid-PVST+, PortFast/BPDU Guard enabled
![MY-KL-HQ-CORE sh spanning-tree summary](../evidences/phase-1-basic-connectivity/10-spanning-tree-summary-my-kl-hq-core.png)
...
![PH-MNL-ACC sh spanning-tree summary](../evidences/phase-1-basic-connectivity/11-spanning-tree-summary-ph-mnl-acc.png)
![TH-BKK-ACC sh spanning-tree summary](../evidences/phase-1-basic-connectivity/12-spanning-tree-summary-th-bkk-acc.png)

## Port Security

**`MY-KL-HQ-CORE# sh port-security int g1/0/11`**
![MY-KL-HQ-CORE port security](../evidences/phase-1-basic-connectivity/13-port-security-my-kl-hq-core.png)

**`PH-MNL-ACC# sh port-security int fa0/1`**
![PH-MNL-ACC port security](../evidences/phase-1-basic-connectivity/14-port-security-ph-mnl-acc.png)

**`TH-BKK-ACC# sh port-security int fa0/1`**
![TH-BKK-ACC port security](../evidences/phase-1-basic-connectivity/15-port-security-th-bkk-acc.png)

## Management SSH

**`TH-BKK-ACC# ssh -l asean.admin 10.10.110.2`** — cross-site SSH session, TH-BKK-ACC to PH-MNL-ACC
![SSH TH-BKK-ACC to PH-MNL-ACC](../evidences/phase-1-basic-connectivity/16-ssh-th-bkk-acc-to-ph-mnl-acc.png)

## OSPF Adjacencies

**`MY-KL-HQ-CORE# sh ip ospf neigh`**
![MY-KL-HQ-CORE OSPF neighbors](../evidences/phase-2-dynamic-routing-ipv6/01-ospf-neighbor-my-kl-hq-core.png)

**`SG-EDGE-GW# sh ip ospf neigh`**
![SG-EDGE-GW OSPF neighbors](../evidences/phase-2-dynamic-routing-ipv6/02-ospf-neighbor-sg-edge-gw.png)

**`PH-MNL-ROAS# sh ip ospf neigh`**
![PH-MNL-ROAS OSPF neighbors](../evidences/phase-2-dynamic-routing-ipv6/03-ospf-neighbor-ph-mnl-roas.png)

**`TH-BKK-ROAS# sh ip ospf neigh`**
![TH-BKK-ROAS OSPF neighbors](../evidences/phase-2-dynamic-routing-ipv6/04-ospf-neighbor-th-bkk-roas.png)

## OSPF Routing Table

**`PH-MNL-ROAS# sh ip route ospf`**
![PH-MNL-ROAS OSPF routes](../evidences/phase-2-dynamic-routing-ipv6/05-ip-route-ospf-ph-mnl-roas.png)

**`TH-BKK-ROAS# sh ip route ospf`**
![TH-BKK-ROAS OSPF routes](../evidences/phase-2-dynamic-routing-ipv6/06-ip-route-ospf-th-bkk-roas.png)
...
![MY-KL-HQ-CORE OSPF routes](../evidences/phase-2-dynamic-routing-ipv6/07-ip-route-ospf-my-kl-hq-core.png)

## End-to-End Reachability

**`PH-MNL-ACC# ping 10.10.120.1`** — 100% success, cross-VLAN via ROAS
![Ping to 10.10.120.1](../evidences/phase-2-dynamic-routing-ipv6/08-ping-ph-mnl-acc-to-vlan120.png)
...
![Ping to 10.10.110.1](../evidences/phase-2-dynamic-routing-ipv6/09-ping-ph-mnl-acc-to-vlan110.png)
...
![Ping from TH-BKK-ACC to PH-MNL-ROAS](../evidences/phase-2-dynamic-routing-ipv6/10-ping-th-bkk-acc-to-ph-mnl-roas.png)

## IPv6 Dual-Stack

**`PH-MNL-ROAS# sh ipv6 int brief`**
![PH-MNL-ROAS IPv6 interfaces](../evidences/phase-2-dynamic-routing-ipv6/11-ipv6-int-brief-ph-mnl-roas.png)

**`TH-BKK-ROAS# sh ipv6 int brief`**
![TH-BKK-ROAS IPv6 interfaces](../evidences/phase-2-dynamic-routing-ipv6/12-ipv6-int-brief-th-bkk-roas.png)
...
![MY-KL-HQ-CORE IPv6 interfaces, part 1](../evidences/phase-2-dynamic-routing-ipv6/13-ipv6-int-brief-my-kl-hq-core-part1.png)
![MY-KL-HQ-CORE IPv6 interfaces, part 2](../evidences/phase-2-dynamic-routing-ipv6/14-ipv6-int-brief-my-kl-hq-core-part2.png)

**`SG-EDGE-GW# sh ipv6 int brief`**
![SG-EDGE-GW IPv6 interfaces](../evidences/phase-2-dynamic-routing-ipv6/15-ipv6-int-brief-sg-edge-gw.png)
...
![MY-KL-HQ-CORE IPv6 routing table](../evidences/phase-2-dynamic-routing-ipv6/16-ipv6-route-my-kl-hq-core.png)

**`SG-EDGE-GW# sh ipv6 route`** — single default route back to the hub
![SG-EDGE-GW IPv6 routing table](../evidences/phase-2-dynamic-routing-ipv6/17-ipv6-route-sg-edge-gw.png)

**`PH-MNL-ROAS# sh ipv6 route`** — single default route back to the hub
![PH-MNL-ROAS IPv6 routing table](../evidences/phase-2-dynamic-routing-ipv6/18-ipv6-route-ph-mnl-roas.png)

**`TH-BKK-ROAS# sh ipv6 route`** — single default route back to the hub
![TH-BKK-ROAS IPv6 routing table](../evidences/phase-2-dynamic-routing-ipv6/19-ipv6-route-th-bkk-roas.png)
...
not just addressing.
![Cross-site IPv6 ping, PH-MNL-ROAS to TH-BKK-ROAS](../evidences/phase-2-dynamic-routing-ipv6/20-ping-ipv6-ph-mnl-roas-to-th-bkk-roas.png)
